...
I got a **Bad Gateway** response. This appears to be related to the ingress controller behavior/configuration. I tested switching to NGINX ingress and also creating middleware, and it worked at one point when i used middleware, but the same setup was not stable when i tried it again it didnt work. I am still investigating the problem.
