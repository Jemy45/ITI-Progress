...
### (5 points) Kubectl config
- Created a k3s cluster with 1 server and 1 worker
- Created namespace `iti-46`
- Added context `iti-context` using default user and namespace `iti-46`

### (5 points) Kubectl plugin
- Created plugin `kubectl hostnames` to display node hostnames

### (10 points) Creating deployments
- Created a deployment YAML for image `nginx:alpine`
- Set replicas to `3`
- Added environment variable `FOO=ITI` to pods
